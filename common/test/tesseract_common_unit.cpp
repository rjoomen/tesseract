...
{
  tesseract::common::ResourceLocator::Ptr locator = std::make_shared<tesseract::common::GeneralResourceLocator>();
  tesseract::common::Resource::Ptr resource = locator->locateResource("package://tesseract/package.xml");
